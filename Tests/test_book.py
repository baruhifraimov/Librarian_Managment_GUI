...
class TestBook(unittest.TestCase):
    ...
    def test_add_to_watch_list_success(self):
        """
        Test adding a user to the watch list.
        """
    ...
    def test_add_to_watch_list_user_already_in_list(self):
        """
        Test adding a user to the watch list when they are already in the list.
        """
        user = ("John Doe", "john@example.com", "1234567890")
        self.book.add_to_watch_list(user)
    ...
    def test_add_to_watch_list_blank_fields(self):
        """
        Test adding a user to the watch list with blank fields.
        """
    ...
    def test_decrease_watch_list_success(self):
        """
        Test removing a user from the watch list.
        """
        user = ("John Doe", "john@example.com", "1234567890")
        self.book.add_to_watch_list(user)
    ...
    def test_decrease_watch_list_below_zero(self):
        """
        Test removing a user from the watch list when the list is empty.
        """
    ...
    def test_return_action_exceed_limit(self):
        """
        Test returning a book when the limit is exceeded.
        """
    ...
    def test_borrow_action_exceed_limit(self):
        """
        Test borrowing a book when the limit is exceeded.
        """
    ...
    def test_is_available(self):
        """
        Test checking if a book is available.
        """
